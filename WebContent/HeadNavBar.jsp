			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="pull-left" href="Initial.jsp"><img
						src="ottoImages/otto_corner_navbar.jpeg" width="45px"
						height="45px" style="margin-top:3px"></a>
				</div>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						<li class=""><a href="GoToHomeServlet">Home <span class="sr-only">(current)</span></a></li>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="OttoRegister.jsp">Register</a></li>
							</ul></li>

						<li><form class="navbar-form navbar-center"
								action="AttemptLoginServlet" method="post">
